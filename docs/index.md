...
- Architecture decisions A1–A6: [architecture/decisions.md](architecture/decisions.md)
- Pipeline: [architecture/how-it-works.md](architecture/how-it-works.md)
- Ingest runbook: [operations/ingest.md](operations/ingest.md)
